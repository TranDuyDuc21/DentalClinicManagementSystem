    ...
    <%@ taglib prefix="c" uri="jakarta.tags.core" %>
        ...
        <div class="dashboard-sidebar">
            <div class="sidebar-header">
                <a href="${sessionScope.loggedUser.roleName == 'Customer' ? pageContext.request.contextPath.concat('/home') : pageContext.request.contextPath.concat('/dashboard')}"
                    class="logo">
                    ...
                    <c:if test="${sessionScope.loggedUser.roleName == 'Admin'}">
                        ...
                        <li class="nav-item">
                            <a href="${pageContext.request.contextPath}/employees"
                                class="nav-link ${currentPage == 'employees' ? 'active' : ''}">
