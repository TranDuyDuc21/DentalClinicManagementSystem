        ...
        <form action="${pageContext.request.contextPath}/profile" method="POST" class="validate-form">
            ...
            <div class="form-group" style="margin-bottom: 15px;">
                ...
                <div style="position: relative;">
                    <input type="password" id="currentPassword" name="currentPassword" class="form-control" required pattern=".*\S.*" title="Mật khẩu không được chỉ chứa khoảng trắng" style="padding-right: 40px;">
            ...
            <div class="form-group" style="margin-bottom: 15px;">
                ...
                <div style="position: relative;">
                    <input type="password" id="newPassword" name="newPassword" class="form-control" required minlength="6" pattern=".*\S.*" title="Mật khẩu không được chỉ chứa khoảng trắng" style="padding-right: 40px;">
            ...
            <div class="form-group" style="margin-bottom: 25px;">
                ...
                <div style="position: relative;">
                    <input type="password" id="confirmPassword" name="confirmPassword" class="form-control" required data-match="newPassword" pattern=".*\S.*" title="Mật khẩu không được chỉ chứa khoảng trắng" style="padding-right: 40px;">
